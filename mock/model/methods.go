...
func NewUser() *User {
	m := &User{}
	m.Init(m, nil, nil)
	m.Id.Init(m, "Id", "Id", "Id", 0)
	m.IntelUserCode.Init(m, "IntelUserCode", "IntelUserCode", "IntelUserCode", 1)
	m.UserCode.Init(m, "UserCode", "UserCode", "UserCode", 2)
	m.Name.Init(m, "Name", "Name", "Name", 3)
	m.Sex.Init(m, "Sex", "Sex", "Sex", 4)
	m.IdentityType.Init(m, "IdentityType", "IdentityType", "IdentityType", 5)
	m.IdentityNum.Init(m, "IdentityNum", "IdentityNum", "IdentityNum", 6)
	m.ExpirationDate.Init(m, "ExpirationDate", "ExpirationDate", "ExpirationDate", 7)
	m.UniversityCode.Init(m, "UniversityCode", "UniversityCode", "UniversityCode", 8)
	m.UserType.Init(m, "UserType", "UserType", "UserType", 9)
	m.EnrollmentStatus.Init(m, "EnrollmentStatus", "EnrollmentStatus", "EnrollmentStatus", 10)
	m.Type.Init(m, "Type", "Type", "Type", 11)
	m.Password.Init(m, "Password", "Password", "Password", 12)
	m.Phone.Init(m, "Phone", "Phone", "Phone", 13)
	m.Email.Init(m, "Email", "Email", "Email", 14)
	m.PictureURL.Init(m, "PictureURL", "PictureURL", "PictureURL", 15)
	m.Question.Init(m, "Question", "Question", "Question", 16)
	m.Answer.Init(m, "Answer", "Answer", "Answer", 17)
	m.AvailableLogin.Init(m, "AvailableLogin", "AvailableLogin", "AvailableLogin", 18)
	m.Operator.Init(m, "Operator", "Operator", "Operator", 19)
	m.InsertDatetime.Init(m, "InsertDatetime", "InsertDatetime", "InsertDatetime", 20)
	m.UpdateDatetime.Init(m, "UpdateDatetime", "UpdateDatetime", "UpdateDatetime", 21)
	m.Status.Init(m, "Status", "Status", "Status", 22)
	m.Remark1.Init(m, "Remark1", "Remark1", "Remark1", 23)
	m.Remark2.Init(m, "Remark2", "Remark2", "Remark2", 24)
	m.Remark3.Init(m, "Remark3", "Remark3", "Remark3", 25)
	m.Remark4.Init(m, "Remark4", "Remark4", "Remark4", 26)
	m.Nonego.Init(m, "Nonego", "Nonego", "Nonego", 27)
	m.InitRel()
	return m
}
...
func NewUserList() *UserList {
	...
	l.Init(l, nil, nil)
	l.Id.Init(l, "Id", "Id", "Id", 0)
	l.IntelUserCode.Init(l, "IntelUserCode", "IntelUserCode", "IntelUserCode", 1)
	l.UserCode.Init(l, "UserCode", "UserCode", "UserCode", 2)
	l.Name.Init(l, "Name", "Name", "Name", 3)
	l.Sex.Init(l, "Sex", "Sex", "Sex", 4)
	l.IdentityType.Init(l, "IdentityType", "IdentityType", "IdentityType", 5)
	l.IdentityNum.Init(l, "IdentityNum", "IdentityNum", "IdentityNum", 6)
	l.ExpirationDate.Init(l, "ExpirationDate", "ExpirationDate", "ExpirationDate", 7)
	l.UniversityCode.Init(l, "UniversityCode", "UniversityCode", "UniversityCode", 8)
	l.UserType.Init(l, "UserType", "UserType", "UserType", 9)
	l.EnrollmentStatus.Init(l, "EnrollmentStatus", "EnrollmentStatus", "EnrollmentStatus", 10)
	l.Type.Init(l, "Type", "Type", "Type", 11)
	l.Password.Init(l, "Password", "Password", "Password", 12)
	l.Phone.Init(l, "Phone", "Phone", "Phone", 13)
	l.Email.Init(l, "Email", "Email", "Email", 14)
	l.PictureURL.Init(l, "PictureURL", "PictureURL", "PictureURL", 15)
	l.Question.Init(l, "Question", "Question", "Question", 16)
	l.Answer.Init(l, "Answer", "Answer", "Answer", 17)
	l.AvailableLogin.Init(l, "AvailableLogin", "AvailableLogin", "AvailableLogin", 18)
	l.Operator.Init(l, "Operator", "Operator", "Operator", 19)
	l.InsertDatetime.Init(l, "InsertDatetime", "InsertDatetime", "InsertDatetime", 20)
	l.UpdateDatetime.Init(l, "UpdateDatetime", "UpdateDatetime", "UpdateDatetime", 21)
	l.Status.Init(l, "Status", "Status", "Status", 22)
	l.Remark1.Init(l, "Remark1", "Remark1", "Remark1", 23)
	l.Remark2.Init(l, "Remark2", "Remark2", "Remark2", 24)
	l.Remark3.Init(l, "Remark3", "Remark3", "Remark3", 25)
	l.Remark4.Init(l, "Remark4", "Remark4", "Remark4", 26)
	l.Nonego.Init(l, "Nonego", "Nonego", "Nonego", 27)
	l.InitRel()
	return l
}
...
func NewStudentbasicinfo() *Studentbasicinfo {
	...
	m.Init(m, nil, nil)
	m.Id.Init(m, "Id", "Id", "Id", 0)
	m.RecordId.Init(m, "RecordId", "RecordId", "RecordId", 1)
	m.IntelUserCode.Init(m, "IntelUserCode", "IntelUserCode", "IntelUserCode", 2)
	m.Class.Init(m, "Class", "Class", "Class", 3)
	m.OtherName.Init(m, "OtherName", "OtherName", "OtherName", 4)
	m.NameInPinyin.Init(m, "NameInPinyin", "NameInPinyin", "NameInPinyin", 5)
	m.EnglishName.Init(m, "EnglishName", "EnglishName", "EnglishName", 6)
	m.CountryCode.Init(m, "CountryCode", "CountryCode", "CountryCode", 7)
	m.NationalityCode.Init(m, "NationalityCode", "NationalityCode", "NationalityCode", 8)
	m.Birthday.Init(m, "Birthday", "Birthday", "Birthday", 9)
	m.PoliticalCode.Init(m, "PoliticalCode", "PoliticalCode", "PoliticalCode", 10)
	m.QQAcct.Init(m, "QQAcct", "QQAcct", "QQAcct", 11)
	m.WeChatAcct.Init(m, "WeChatAcct", "WeChatAcct", "WeChatAcct", 12)
	m.BankCardNumber.Init(m, "BankCardNumber", "BankCardNumber", "BankCardNumber", 13)
	m.AccountBankCode.Init(m, "AccountBankCode", "AccountBankCode", "AccountBankCode", 14)
	m.AllPowerfulCardNum.Init(m, "AllPowerfulCardNum", "AllPowerfulCardNum", "AllPowerfulCardNum", 15)
	m.MaritalCode.Init(m, "MaritalCode", "MaritalCode", "MaritalCode", 16)
	m.OriginAreaCode.Init(m, "OriginAreaCode", "OriginAreaCode", "OriginAreaCode", 17)
	m.StudentAreaCode.Init(m, "StudentAreaCode", "StudentAreaCode", "StudentAreaCode", 18)
	m.Hobbies.Init(m, "Hobbies", "Hobbies", "Hobbies", 19)
	m.Creed.Init(m, "Creed", "Creed", "Creed", 20)
	m.TrainTicketinterval.Init(m, "TrainTicketinterval", "TrainTicketinterval", "TrainTicketinterval", 21)
	m.FamilyAddress.Init(m, "FamilyAddress", "FamilyAddress", "FamilyAddress", 22)
	m.DetailAddress.Init(m, "DetailAddress", "DetailAddress", "DetailAddress", 23)
	m.PostCode.Init(m, "PostCode", "PostCode", "PostCode", 24)
	m.HomePhone.Init(m, "HomePhone", "HomePhone", "HomePhone", 25)
	m.EnrollmentDate.Init(m, "EnrollmentDate", "EnrollmentDate", "EnrollmentDate", 26)
	m.GraduationDate.Init(m, "GraduationDate", "GraduationDate", "GraduationDate", 27)
	m.MidSchoolAddress.Init(m, "MidSchoolAddress", "MidSchoolAddress", "MidSchoolAddress", 28)
	m.MidSchoolName.Init(m, "MidSchoolName", "MidSchoolName", "MidSchoolName", 29)
	m.Referee.Init(m, "Referee", "Referee", "Referee", 30)
	m.RefereeDuty.Init(m, "RefereeDuty", "RefereeDuty", "RefereeDuty", 31)
	m.RefereePhone.Init(m, "RefereePhone", "RefereePhone", "RefereePhone", 32)
	m.AdmissionTicketNo.Init(m, "AdmissionTicketNo", "AdmissionTicketNo", "AdmissionTicketNo", 33)
	m.CollegeEntranceExamScores.Init(m, "CollegeEntranceExamScores", "CollegeEntranceExamScores", "CollegeEntranceExamScores", 34)
	m.AdmissionYear.Init(m, "AdmissionYear", "AdmissionYear", "AdmissionYear", 35)
	m.ForeignLanguageCode.Init(m, "ForeignLanguageCode", "ForeignLanguageCode", "ForeignLanguageCode", 36)
	m.StudentOrigin.Init(m, "StudentOrigin", "StudentOrigin", "StudentOrigin", 37)
	m.BizType.Init(m, "BizType", "BizType", "BizType", 38)
	m.TaskCode.Init(m, "TaskCode", "TaskCode", "TaskCode", 39)
	m.ApproveStatus.Init(m, "ApproveStatus", "ApproveStatus", "ApproveStatus", 40)
	m.Operator.Init(m, "Operator", "Operator", "Operator", 41)
	m.InsertDatetime.Init(m, "InsertDatetime", "InsertDatetime", "InsertDatetime", 42)
	m.UpdateDatetime.Init(m, "UpdateDatetime", "UpdateDatetime", "UpdateDatetime", 43)
	m.Status.Init(m, "Status", "Status", "Status", 44)
	m.StudentStatus.Init(m, "StudentStatus", "StudentStatus", "StudentStatus", 45)
	m.IsAuth.Init(m, "IsAuth", "IsAuth", "IsAuth", 46)
	m.Campus.Init(m, "Campus", "Campus", "Campus", 47)
	m.Zone.Init(m, "Zone", "Zone", "Zone", 48)
	m.Building.Init(m, "Building", "Building", "Building", 49)
	m.Unit.Init(m, "Unit", "Unit", "Unit", 50)
	m.Room.Init(m, "Room", "Room", "Room", 51)
	m.Bed.Init(m, "Bed", "Bed", "Bed", 52)
	m.StatusSort.Init(m, "StatusSort", "StatusSort", "StatusSort", 53)
	m.Height.Init(m, "Height", "Height", "Height", 54)
	m.Weight.Init(m, "Weight", "Weight", "Weight", 55)
	m.FootSize.Init(m, "FootSize", "FootSize", "FootSize", 56)
	m.ClothSize.Init(m, "ClothSize", "ClothSize", "ClothSize", 57)
	m.HeadSize.Init(m, "HeadSize", "HeadSize", "HeadSize", 58)
	m.Remark1.Init(m, "Remark1", "Remark1", "Remark1", 59)
	m.Remark2.Init(m, "Remark2", "Remark2", "Remark2", 60)
	m.Remark3.Init(m, "Remark3", "Remark3", "Remark3", 61)
	m.Remark4.Init(m, "Remark4", "Remark4", "Remark4", 62)
	m.IsPayment.Init(m, "IsPayment", "IsPayment", "IsPayment", 63)
	m.IsCheckIn.Init(m, "isCheckIn", "IsCheckIn", "IsCheckIn", 64)
	m.GetMilitaryTC.Init(m, "GetMilitaryTC", "GetMilitaryTC", "GetMilitaryTC", 65)
	m.OriginAreaName.Init(m, "OriginAreaName", "OriginAreaName", "OriginAreaName", 66)
	m.InitRel()
	return m
}
...
func NewStudentbasicinfoList() *StudentbasicinfoList {
	...
	l.Init(l, nil, nil)
	l.Id.Init(l, "Id", "Id", "Id", 0)
	l.RecordId.Init(l, "RecordId", "RecordId", "RecordId", 1)
	l.IntelUserCode.Init(l, "IntelUserCode", "IntelUserCode", "IntelUserCode", 2)
	l.Class.Init(l, "Class", "Class", "Class", 3)
	l.OtherName.Init(l, "OtherName", "OtherName", "OtherName", 4)
	l.NameInPinyin.Init(l, "NameInPinyin", "NameInPinyin", "NameInPinyin", 5)
	l.EnglishName.Init(l, "EnglishName", "EnglishName", "EnglishName", 6)
	l.CountryCode.Init(l, "CountryCode", "CountryCode", "CountryCode", 7)
	l.NationalityCode.Init(l, "NationalityCode", "NationalityCode", "NationalityCode", 8)
	l.Birthday.Init(l, "Birthday", "Birthday", "Birthday", 9)
	l.PoliticalCode.Init(l, "PoliticalCode", "PoliticalCode", "PoliticalCode", 10)
	l.QQAcct.Init(l, "QQAcct", "QQAcct", "QQAcct", 11)
	l.WeChatAcct.Init(l, "WeChatAcct", "WeChatAcct", "WeChatAcct", 12)
	l.BankCardNumber.Init(l, "BankCardNumber", "BankCardNumber", "BankCardNumber", 13)
	l.AccountBankCode.Init(l, "AccountBankCode", "AccountBankCode", "AccountBankCode", 14)
	l.AllPowerfulCardNum.Init(l, "AllPowerfulCardNum", "AllPowerfulCardNum", "AllPowerfulCardNum", 15)
	l.MaritalCode.Init(l, "MaritalCode", "MaritalCode", "MaritalCode", 16)
	l.OriginAreaCode.Init(l, "OriginAreaCode", "OriginAreaCode", "OriginAreaCode", 17)
	l.StudentAreaCode.Init(l, "StudentAreaCode", "StudentAreaCode", "StudentAreaCode", 18)
	l.Hobbies.Init(l, "Hobbies", "Hobbies", "Hobbies", 19)
	l.Creed.Init(l, "Creed", "Creed", "Creed", 20)
	l.TrainTicketinterval.Init(l, "TrainTicketinterval", "TrainTicketinterval", "TrainTicketinterval", 21)
	l.FamilyAddress.Init(l, "FamilyAddress", "FamilyAddress", "FamilyAddress", 22)
	l.DetailAddress.Init(l, "DetailAddress", "DetailAddress", "DetailAddress", 23)
	l.PostCode.Init(l, "PostCode", "PostCode", "PostCode", 24)
	l.HomePhone.Init(l, "HomePhone", "HomePhone", "HomePhone", 25)
	l.EnrollmentDate.Init(l, "EnrollmentDate", "EnrollmentDate", "EnrollmentDate", 26)
	l.GraduationDate.Init(l, "GraduationDate", "GraduationDate", "GraduationDate", 27)
	l.MidSchoolAddress.Init(l, "MidSchoolAddress", "MidSchoolAddress", "MidSchoolAddress", 28)
	l.MidSchoolName.Init(l, "MidSchoolName", "MidSchoolName", "MidSchoolName", 29)
	l.Referee.Init(l, "Referee", "Referee", "Referee", 30)
	l.RefereeDuty.Init(l, "RefereeDuty", "RefereeDuty", "RefereeDuty", 31)
	l.RefereePhone.Init(l, "RefereePhone", "RefereePhone", "RefereePhone", 32)
	l.AdmissionTicketNo.Init(l, "AdmissionTicketNo", "AdmissionTicketNo", "AdmissionTicketNo", 33)
	l.CollegeEntranceExamScores.Init(l, "CollegeEntranceExamScores", "CollegeEntranceExamScores", "CollegeEntranceExamScores", 34)
	l.AdmissionYear.Init(l, "AdmissionYear", "AdmissionYear", "AdmissionYear", 35)
	l.ForeignLanguageCode.Init(l, "ForeignLanguageCode", "ForeignLanguageCode", "ForeignLanguageCode", 36)
	l.StudentOrigin.Init(l, "StudentOrigin", "StudentOrigin", "StudentOrigin", 37)
	l.BizType.Init(l, "BizType", "BizType", "BizType", 38)
	l.TaskCode.Init(l, "TaskCode", "TaskCode", "TaskCode", 39)
	l.ApproveStatus.Init(l, "ApproveStatus", "ApproveStatus", "ApproveStatus", 40)
	l.Operator.Init(l, "Operator", "Operator", "Operator", 41)
	l.InsertDatetime.Init(l, "InsertDatetime", "InsertDatetime", "InsertDatetime", 42)
	l.UpdateDatetime.Init(l, "UpdateDatetime", "UpdateDatetime", "UpdateDatetime", 43)
	l.Status.Init(l, "Status", "Status", "Status", 44)
	l.StudentStatus.Init(l, "StudentStatus", "StudentStatus", "StudentStatus", 45)
	l.IsAuth.Init(l, "IsAuth", "IsAuth", "IsAuth", 46)
	l.Campus.Init(l, "Campus", "Campus", "Campus", 47)
	l.Zone.Init(l, "Zone", "Zone", "Zone", 48)
	l.Building.Init(l, "Building", "Building", "Building", 49)
	l.Unit.Init(l, "Unit", "Unit", "Unit", 50)
	l.Room.Init(l, "Room", "Room", "Room", 51)
	l.Bed.Init(l, "Bed", "Bed", "Bed", 52)
	l.StatusSort.Init(l, "StatusSort", "StatusSort", "StatusSort", 53)
	l.Height.Init(l, "Height", "Height", "Height", 54)
	l.Weight.Init(l, "Weight", "Weight", "Weight", 55)
	l.FootSize.Init(l, "FootSize", "FootSize", "FootSize", 56)
	l.ClothSize.Init(l, "ClothSize", "ClothSize", "ClothSize", 57)
	l.HeadSize.Init(l, "HeadSize", "HeadSize", "HeadSize", 58)
	l.Remark1.Init(l, "Remark1", "Remark1", "Remark1", 59)
	l.Remark2.Init(l, "Remark2", "Remark2", "Remark2", 60)
	l.Remark3.Init(l, "Remark3", "Remark3", "Remark3", 61)
	l.Remark4.Init(l, "Remark4", "Remark4", "Remark4", 62)
	l.IsPayment.Init(l, "IsPayment", "IsPayment", "IsPayment", 63)
	l.IsCheckIn.Init(l, "isCheckIn", "IsCheckIn", "IsCheckIn", 64)
	l.GetMilitaryTC.Init(l, "GetMilitaryTC", "GetMilitaryTC", "GetMilitaryTC", 65)
	l.OriginAreaName.Init(l, "OriginAreaName", "OriginAreaName", "OriginAreaName", 66)
	l.InitRel()
	return l
}
...
func NewClass() *Class {
	...
	m.Id.Init(m, "Id", "Id", "Id", 0)
	m.RecordId.Init(m, "RecordId", "RecordId", "RecordId", 1)
	m.ClassCode.Init(m, "ClassCode", "ClassCode", "ClassCode", 2)
	m.ClassName.Init(m, "ClassName", "ClassName", "ClassName", 3)
	m.Campus.Init(m, "Campus", "Campus", "Campus", 4)
	m.ResearchArea.Init(m, "ResearchArea", "ResearchArea", "ResearchArea", 5)
	m.Grade.Init(m, "Grade", "Grade", "Grade", 6)
	m.TrainingMode.Init(m, "TrainingMode", "TrainingMode", "TrainingMode", 7)
	m.EntranceDate.Init(m, "EntranceDate", "EntranceDate", "EntranceDate", 8)
	m.GraduationDate.Init(m, "GraduationDate", "GraduationDate", "GraduationDate", 9)
	m.ProgramLength.Init(m, "ProgramLength", "ProgramLength", "ProgramLength", 10)
	m.StudentType.Init(m, "StudentType", "StudentType", "StudentType", 11)
	m.CredentialsType.Init(m, "CredentialsType", "CredentialsType", "CredentialsType", 12)
	m.DegreeType.Init(m, "DegreeType", "DegreeType", "DegreeType", 13)
	m.Counselor.Init(m, "Counselor", "Counselor", "Counselor", 14)
	m.Adviser.Init(m, "Adviser", "Adviser", "Adviser", 15)
	m.Leadership.Init(m, "Leadership", "Leadership", "Leadership", 16)
	m.Supervisor.Init(m, "Supervisor", "Supervisor", "Supervisor", 17)
	m.Assistant1.Init(m, "Assistant1", "Assistant1", "Assistant1", 18)
	m.Assistant2.Init(m, "Assistant2", "Assistant2", "Assistant2", 19)
	m.Operator.Init(m, "Operator", "Operator", "Operator", 20)
	m.InsertDatetime.Init(m, "InsertDatetime", "InsertDatetime", "InsertDatetime", 21)
	m.UpdateDatetime.Init(m, "UpdateDatetime", "UpdateDatetime", "UpdateDatetime", 22)
	m.Status.Init(m, "Status", "Status", "Status", 23)
	m.Remark1.Init(m, "Remark1", "Remark1", "Remark1", 24)
	m.Remark2.Init(m, "Remark2", "Remark2", "Remark2", 25)
	m.Remark3.Init(m, "Remark3", "Remark3", "Remark3", 26)
	m.Remark4.Init(m, "Remark4", "Remark4", "Remark4", 27)
	m.InitRel()
	return m
}
...
func NewClassList() *ClassList {
	...
	l.Id.Init(l, "Id", "Id", "Id", 0)
	l.RecordId.Init(l, "RecordId", "RecordId", "RecordId", 1)
	l.ClassCode.Init(l, "ClassCode", "ClassCode", "ClassCode", 2)
	l.ClassName.Init(l, "ClassName", "ClassName", "ClassName", 3)
	l.Campus.Init(l, "Campus", "Campus", "Campus", 4)
	l.ResearchArea.Init(l, "ResearchArea", "ResearchArea", "ResearchArea", 5)
	l.Grade.Init(l, "Grade", "Grade", "Grade", 6)
	l.TrainingMode.Init(l, "TrainingMode", "TrainingMode", "TrainingMode", 7)
	l.EntranceDate.Init(l, "EntranceDate", "EntranceDate", "EntranceDate", 8)
	l.GraduationDate.Init(l, "GraduationDate", "GraduationDate", "GraduationDate", 9)
	l.ProgramLength.Init(l, "ProgramLength", "ProgramLength", "ProgramLength", 10)
	l.StudentType.Init(l, "StudentType", "StudentType", "StudentType", 11)
	l.CredentialsType.Init(l, "CredentialsType", "CredentialsType", "CredentialsType", 12)
	l.DegreeType.Init(l, "DegreeType", "DegreeType", "DegreeType", 13)
	l.Counselor.Init(l, "Counselor", "Counselor", "Counselor", 14)
	l.Adviser.Init(l, "Adviser", "Adviser", "Adviser", 15)
	l.Leadership.Init(l, "Leadership", "Leadership", "Leadership", 16)
	l.Supervisor.Init(l, "Supervisor", "Supervisor", "Supervisor", 17)
	l.Assistant1.Init(l, "Assistant1", "Assistant1", "Assistant1", 18)
	l.Assistant2.Init(l, "Assistant2", "Assistant2", "Assistant2", 19)
	l.Operator.Init(l, "Operator", "Operator", "Operator", 20)
	l.InsertDatetime.Init(l, "InsertDatetime", "InsertDatetime", "InsertDatetime", 21)
	l.UpdateDatetime.Init(l, "UpdateDatetime", "UpdateDatetime", "UpdateDatetime", 22)
	l.Status.Init(l, "Status", "Status", "Status", 23)
	l.Remark1.Init(l, "Remark1", "Remark1", "Remark1", 24)
	l.Remark2.Init(l, "Remark2", "Remark2", "Remark2", 25)
	l.Remark3.Init(l, "Remark3", "Remark3", "Remark3", 26)
	l.Remark4.Init(l, "Remark4", "Remark4", "Remark4", 27)
	l.InitRel()
	return l
}
...
func NewGrade() *Grade {
	...
	m.Init(m, nil, nil)
	m.Id.Init(m, "Id", "Id", "Id", 0)
	m.GradeName.Init(m, "GradeName", "GradeName", "GradeName", 1)
	m.GradeCode.Init(m, "GradeCode", "GradeCode", "GradeCode", 2)
	m.InsertDatetime.Init(m, "InsertDatetime", "InsertDatetime", "InsertDatetime", 3)
	m.UpdateDatetime.Init(m, "UpdateDatetime", "UpdateDatetime", "UpdateDatetime", 4)
	m.Status.Init(m, "Status", "Status", "Status", 5)
	m.Remark1.Init(m, "Remark1", "Remark1", "Remark1", 6)
	m.Remark2.Init(m, "Remark2", "Remark2", "Remark2", 7)
	m.Remark3.Init(m, "Remark3", "Remark3", "Remark3", 8)
	m.Remark4.Init(m, "Remark4", "Remark4", "Remark4", 9)
	m.InitRel()
	return m
}
...
func NewGradeList() *GradeList {
	...
	l.Init(l, nil, nil)
	l.Id.Init(l, "Id", "Id", "Id", 0)
	l.GradeName.Init(l, "GradeName", "GradeName", "GradeName", 1)
	l.GradeCode.Init(l, "GradeCode", "GradeCode", "GradeCode", 2)
	l.InsertDatetime.Init(l, "InsertDatetime", "InsertDatetime", "InsertDatetime", 3)
	l.UpdateDatetime.Init(l, "UpdateDatetime", "UpdateDatetime", "UpdateDatetime", 4)
	l.Status.Init(l, "Status", "Status", "Status", 5)
	l.Remark1.Init(l, "Remark1", "Remark1", "Remark1", 6)
	l.Remark2.Init(l, "Remark2", "Remark2", "Remark2", 7)
	l.Remark3.Init(l, "Remark3", "Remark3", "Remark3", 8)
	l.Remark4.Init(l, "Remark4", "Remark4", "Remark4", 9)
	l.InitRel()
	return l
}
