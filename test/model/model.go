...
type Enterprise struct {
	...
	Sector           *JobFlag           `rel:"SectorID->ID"`
}
...
type EnterpriseJob struct {
	...
	StudentResumes  *StudentResumeList `rel:"ID->MidStudentResumeEnterpriseJob[@ReviewStatus=1 OR @ReviewStatus=2].JobID->MidEnterpriseJobStudentResume.ResumeID->ID"`
}
